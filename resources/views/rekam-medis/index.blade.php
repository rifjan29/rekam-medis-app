<x-app-layout>
    @include('rekam-medis.modal.create')
    @include('rekam-medis.modal.show')
    @include('rekam-medis.modal.edit')
    @push('js')
        <script>
            // show
                            ...
                            <tbody>
                                @forelse ($data as $item)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ ucwords($item->no_rm) }}</th>
