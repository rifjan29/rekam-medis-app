                ...
                <form action="{{ route('rekam-medis.store') }}" method="POST" class="w-full mx-auto" >
                    ...
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 sm:gap-6 mb-5">
                        ...
                        <div class="">
                            ...
                            <input type="text" datepicker  datepicker-format="yyyy-mm-dd" name="tgl_lahir" id="tgl_lahir" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Masukkan Tanggal Lahir">
                        </div>
                        <div class="col-span-2 sm:col-span-2">
