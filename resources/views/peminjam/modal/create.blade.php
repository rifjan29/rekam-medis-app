                ...
                <form action="{{ route('peminjaman.store') }}" method="POST" class="w-full mx-auto" >
                    ...
                    <div class="grid gap-4 grid-cols-2 sm:grid-cols-2 sm:gap-6 mb-5">
                        ...
                        <div class="col-span-2 sm:col-span-2 unit_igd hidden" id="unit_igd">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dirujuk Ke </label>
                            <select id="unit" name="unit_igd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <option value="0">Pilih Unit</option>
